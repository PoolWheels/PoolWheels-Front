    ...
    return (
        <div>
            ...
            <div class="blockMain1D">
                <div class="blockMis1D">
                    ...
                    <div class="blockTxtAbt1D">
                        <label class="label1D">Genera ganancias por viajes realizados. Organiza tus horarios y dispone de tu tiempo.</label>
                    </div>
                </div>
                <div class="blockVis1D">
                    ...
                    <div class="blockTxtAbt1D">
                        <label class="label1D">Transporte colectivo en un entorno común entre estudiantes universitarios y empleados.</label>
                    </div>
                </div>
            ...
            <footer id="blockInfo1D">
                <a href="Contact" class="optFooter1D">Contacto</a>
            </footer>
        </div>
    )
}
